...
一般的に強いデッキや環境Tierを紹介するアプリではなく、  
「このユーザ × このデッキ × この環境」における実データをもとに、  
**デッキ構成改善の意思決定を支援する**ことを目的としています。
...
DB の詳細な設計・前提条件については、`docs/` 以下に記載予定です。
...
- 本アプリは統計的な正解や最適解を保証するものではありません
- 分析結果はあくまで **検討材料** です
- 少数サンプルでの傾向把握を前提としています
